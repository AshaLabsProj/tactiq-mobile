...
const styles = StyleSheet.create({
  ...
  playerChoice: { width: 84, minHeight: 92, borderRadius: 18, backgroundColor: palette.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: palette.border, alignItems: "center", justifyContent: "center", gap: 6 },
  playerChoiceSelected: { backgroundColor: palette.primarySoft, borderColor: palette.primary },
  playerChoiceName: { color: palette.muted, fontSize: 12, lineHeight: 16, fontWeight: "600", maxWidth: 72 },
  ...
  ratingOption: { flex: 1, minHeight: 48, borderRadius: 12, backgroundColor: palette.surfaceAlt, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "transparent" },
  ratingOptionSelected: { backgroundColor: palette.primarySoft, borderColor: palette.primary },
  ratingNumber: { color: palette.ink, fontSize: 16, lineHeight: 21, fontWeight: "700" },
